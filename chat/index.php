...
<head>
  <meta charset="UTF-8">
  <title><?php echo $chat->getUsername($_GET['sent_to']); ?></title>
...
MSG;
                  ...
                  <div class="msg-wgt-footer">
                    <textarea id="chatMsg" class="mb-n1" data="<?php echo $_GET['sent_to']; ?>" placeholder="Type your message. Press Enter to send"></textarea>
                  </div>
                </div>
                <?php
          }
